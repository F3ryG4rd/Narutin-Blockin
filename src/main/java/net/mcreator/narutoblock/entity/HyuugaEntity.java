...
package net.mcreator.narutoblock.entity;
...
import net.mcreator.narutoblock.item.ChakraHyuugaItem;
...
public class HyuugaEntity extends NarutoBlockModElements.ModElement {
	...
	public void initElements() {
		entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT).setShouldReceiveVelocityUpdates(true)
				.setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire().size(0.6f, 1.8f)).build("hyuuga")
						.setRegistryName("hyuuga");
		elements.entities.add(() -> entity);
		elements.items.add(() -> new SpawnEggItem(entity, -6697729, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("hyuuga"));
	}
		...
		RenderingRegistry.registerEntityRenderingHandler(entity, renderManager -> {
			BipedRenderer customRender = new BipedRenderer(renderManager, new BipedModel(0), 0.5f) {
				...
				public ResourceLocation getEntityTexture(Entity entity) {
					return new ResourceLocation("naruto_block:textures/nejihyuuga.png");
				}
			};
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(ChakraHyuugaItem.block, (int) (1)));
		}
